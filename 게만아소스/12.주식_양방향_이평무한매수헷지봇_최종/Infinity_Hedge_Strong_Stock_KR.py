                    ...
                    if StockInfo['IsReady'] == 'Y' and StockInfo['IsTralling'] =='N':
                        ...
                        if Ma20 > CurrentPrice: #20선 밑에 있다면 1/4의 금액만큼 헷징들어간다!
                            ...
                            if StockInfo['Inverse_Hedge_WaterAmt'] != 0 and Ma20 < CurrentPrice:
                                ...
                                #현재가보다 아래에 매도 주문을 넣음으로써 시장가로 매도효과!
                                pprint.pprint(KisKR.MakeSellMarketOrder(ShortCode,StockInfo['Inverse_Hedge_WaterAmt']))
                                ...
                                if Short_stock_revenue_money < 0:
                                    ...
                                    msg = KisKR.GetStockName(ShortCode) + "("+ ShortCode  + ")  20선 위로 올라와서 숏 매도합니다! 약 [" + str(LossMoney) + "] 확정손실이 나서 기록했으며 누적 손실은 [" + str(StockInfo['S_WaterLossMoney']) + "] 입니다"
                                    print(msg) 
                                    line_alert.SendMessage(msg) 
                                ...
                                #이 경우는 이득 본 경우다!
                                    ...
                                    msg = KisKR.GetStockName(ShortCode) + "("+ ShortCode  + ") 20선 위로 올라와서 숏 매도합니다! 약 [" + str(RevenuMoney) + "] 확정 수익이 났네요! 누적 손실은 [" + str(StockInfo['S_WaterLossMoney']) + "] 입니다"
                                    print(msg) 
                                    line_alert.SendMessage(msg) 
