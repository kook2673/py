...
# 상위 10개 코인을 가져옵니다.
print("#########################################################")
print("시총 상위 10개 코인을 가져옵니다.")
ResultList = GetTopCoinList(Top100CoinList, 10)
print(ResultList)
...
# 스테이블 코인을 가져옵니다.
print("#########################################################")
print("시총 상위 5개의 스테이블 코인을 가져옵니다.")
ResultList = GetTopCoinList(Top100CoinList, 5,['stablecoin'])
print(ResultList)
for idx, coin in enumerate(ResultList, 1):
    print(f"{idx}위: {coin}")
print("#########################################################\n")
...
# 스테이블 코인은 제외하고 상위 10개 코인을 가져옵니다.
print("#########################################################")
print("시총 상위 10개 코인을 가져오되 스테이블 코인은 제외합니다")
ResultList = GetTopCoinList(Top100CoinList, 10,['all'],['stablecoin'])
print(ResultList)
for idx, coin in enumerate(ResultList, 1):
    print(f"{idx}위: {coin}")
print("#########################################################\n")
...
# 거래소 코인을 5개 가져옵니다.
print("#########################################################")
print("시총 상위 5개의 거래소 코인을 가져옵니다.")
ResultList = GetTopCoinList(Top100CoinList, 5,['centralized-exchange'])
print(ResultList)
for idx, coin in enumerate(ResultList, 1):
    print(f"{idx}위: {coin}")
print("#########################################################\n")
...
# 상위 10개 코인을 가져오되 스테이블 코인과 거래소 코인은 제외합니다
print("#########################################################")
print("시총 상위 10개 코인을 가져오되 스테이블 코인과 거래소 코인은 제외합니다")
ResultList = GetTopCoinList(Top100CoinList, 10,['all'],['stablecoin','centralized-exchange'])
print(ResultList)
for idx, coin in enumerate(ResultList, 1):
    print(f"{idx}위: {coin}")
print("#########################################################\n")
