...
#파일 경로입니다.
bot_file_path = "/var/autobot/BinanceSpotMAInfinityFinalV2.json"
    ...
    try: 
        ...
        if PickCoinInfo == None:
            ...
            if coin_amt < Buy_Amt:
                ...
                InfinityDataDict['Date'] = time_info.tm_mday
        ...
        for CoinInfo in InfinityMaDataList:
            ...
            if CoinInfo['Ticker'] == Target_Coin_Ticker:
                ...
                if CoinInfo['IsCheck'] == 'Y' and CoinInfo['IsTralling'] =='N':
                    ...
                    CoinInfo['IsCheck'] = 'N'
                    CoinInfo['Date'] = time_info.tm_mday
...
for CoinInfo in InfinityMaDataList:
    print("날자 비교")
    print(CoinInfo['Date'], " ",time_info.tm_mday)
    if CoinInfo['Date'] != time_info.tm_mday:
        CoinInfo['IsCheck'] = 'Y'
