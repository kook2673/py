...
for stock_code in InvestList:
    ...
    #일봉 정보를 가지고 온다!
    df = Common.GetOhlcv("KR",stock_code, MaxCount) 
        ...
        for ma2 in range(20,121):
            ...
            if ma1 < ma2:
                ...
                if len(TotlMoneyList) > 0:
                    ...
                    FinalResultData['stock_name'] = stock_name
