...
#파일 경로입니다.
#coinfindma_file_path = "./FindDoubleMaList_Coinone.json" #내 PC에서 체크 할때 
coinfindma_file_path = "/var/autobot/FindDoubleMaList_Coinone.json" #서버에 업로드 할 때!
...
for ticker in Tickers:
    ...
    for coin_data in InvestCoinList:
        ...
        #일봉 정보를 가지고 온다!
        df = myCoinone.GetOhlcv(coin_ticker,'1d',GetCount+2)
