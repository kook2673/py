...
#파일 경로입니다.
#coinfindma_file_path = "./FindDoubleMaList_Binance_4h.json" #내 PC에서 체크 할때 
coinfindma_file_path = "/var/autobot/FindDoubleMaList_BinanceS_4h.json" #서버에 업로드 할 때!
...
msg = "바이낸스 더블 이동평균 최적 이평선(4h) 계산 시작!!"
print(msg)
...
for ticker in Tickers:
    ...
    for coin_data in InvestCoinList:
        ...
        #일봉 정보를 가지고 온다!
        df = GetOhlcv(binanceX,coin_ticker, '4h', GetCount)
        time.sleep(0.2)
...
msg = "바이낸스 더블 이동평균 최적 이평선(4h) 계산 끝!!"
print(msg)
line_alert.SendMessage(msg)
