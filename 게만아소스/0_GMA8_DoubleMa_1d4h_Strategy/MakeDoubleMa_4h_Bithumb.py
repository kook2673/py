...
#파일 경로입니다.
#coinfindma_file_path = "./FindDoubleMaList_Bithumb_4h.json" #내 PC에서 체크 할때 
coinfindma_file_path = "/var/autobot/FindDoubleMaList_Bithumb_4h.json" #서버에 업로드 할 때!
...
msg = "빗썸 더블 이동평균 최적 이평선(4h) 계산 시작!!"
print(msg)
...
for ticker in Tickers:
    ...
    for coin_data in InvestCoinList:
        ...
        #일봉 정보를 가지고 온다!
        df = myBithumb.GetOhlcv(coin_ticker,'4h',GetCount+2)
