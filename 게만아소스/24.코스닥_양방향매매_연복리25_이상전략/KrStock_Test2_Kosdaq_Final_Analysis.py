...
df_all['Score'] = df_all['RevenueRate_rank']*3.0 + df_all['MDD_rank']  #수익률에 3을 곱해서 수익에 가중치를 둔 점수 산정!
...
df_up['Score'] = df_up['RevenueRate_rank']*3.0 + df_up['MDD_rank'] 
...
df_wave['Score'] = df_wave['RevenueRate_rank']*3.0 + df_wave['MDD_rank'] 
...
df_down['Score'] = df_down['RevenueRate_rank']*3.0 + df_down['MDD_rank']
