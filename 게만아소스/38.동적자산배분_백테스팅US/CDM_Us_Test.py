...
InvestStockList = ["SPY","EFA","HYG","LQD","VNQ","REM","GLD","TLT","BIL"]
...
for stock_code in InvestStockList:
    ...
    df['Momentum'] = ((df['prevClose'] - df['12month'])/df['12month'])
...
for date in combined_df.index.unique():
    ...
    pick_stock_momentum_top = combined_df.loc[(combined_df.index == date) & (combined_df['stock_code'] != "BIL") & (combined_df['stock_code'] != "HYG") & (combined_df['stock_code'] != "LQD") & (combined_df['stock_code'] != "VNQ") & (combined_df['stock_code'] != "REM") & (combined_df['stock_code'] != "GLD") & (combined_df['stock_code'] != "TLT")].groupby('stock_code')['Momentum'].max().nlargest(1)
    pick_bond_momentum_top = combined_df.loc[(combined_df.index == date) & (combined_df['stock_code'] != "BIL") & (combined_df['stock_code'] != "SPY") & (combined_df['stock_code'] != "EFA") & (combined_df['stock_code'] != "VNQ") & (combined_df['stock_code'] != "REM") & (combined_df['stock_code'] != "GLD") & (combined_df['stock_code'] != "TLT")].groupby('stock_code')['Momentum'].max().nlargest(1)
    pick_rand_momentum_top = combined_df.loc[(combined_df.index == date) & (combined_df['stock_code'] != "BIL") & (combined_df['stock_code'] != "SPY") & (combined_df['stock_code'] != "EFA") & (combined_df['stock_code'] != "HYG") & (combined_df['stock_code'] != "LQD") & (combined_df['stock_code'] != "GLD") & (combined_df['stock_code'] != "TLT")].groupby('stock_code')['Momentum'].max().nlargest(1)
    pick_alt_momentum_top = combined_df.loc[(combined_df.index == date) & (combined_df['stock_code'] != "BIL") & (combined_df['stock_code'] != "SPY") & (combined_df['stock_code'] != "EFA") & (combined_df['stock_code'] != "HYG") & (combined_df['stock_code'] != "LQD") & (combined_df['stock_code'] != "VNQ") & (combined_df['stock_code'] != "REM")].groupby('stock_code')['Momentum'].max().nlargest(1)
    ...
    if len(checkall) == len(NowInvestList) and int(date_object.strftime("%Y")) >= StartYear:
        ...
        for stock_code in pick_stock_momentum_top.index:
        ...
        for stock_code in pick_bond_momentum_top.index:
        ...
        for stock_code in pick_rand_momentum_top.index:
        ...
        for stock_code in pick_alt_momentum_top.index:
            ...
            if investData['IsRebalanceGo'] == True:
                ...
                if len(stock_data) == 1:
                    ...
                    if SafeRate > 0:
                        ...
                        if stock_code == "BIL":
                            investData['InvestRate'] += SafeRate
