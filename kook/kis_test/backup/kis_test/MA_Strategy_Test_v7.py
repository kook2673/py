'''
1. 균등할당에 코스피100, 코스닥100에 총 200개 종목중에 30개에만 균등하게 투자
2. 비율로 투자.
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
def load_ma_values_from_json(filename="MA_Strategy_Test_v7.json"):
    """
...
def save_ma_values_to_json(ma_values, filename="MA_Strategy_Test_v7.json"):
    """
...
def get_or_create_ma_values(stock_codes, test_area="KR", filename="MA_Strategy_Test_v7.json"):
    """
...
def setup_logging():
    ...
    log_filename = os.path.join(logs_dir, f"MA_Strategy_Test_v7_{timestamp}.log")
...
#차트 저장 함수
def save_charts(df, stock_code, timestamp, source_dir, strategy_name="MA_Strategy_v7"):
    """
    차트를 저장하는 함수
...
#결과 저장 함수
def save_results(results, timestamp, source_dir, strategy_name="MA_Strategy_v7"):
    """
...
logging.info("MA_Strategy_Test_v7 시작")
...
for stock_info in InvestStockList:
    ...
    try:
        ...
        #save_charts(df_chart, stock_code, timestamp, source_dir, "MA_Strategy_v7")
    except Exception as e:
...
for date in combined_df.index.unique():
    ...
    for stock_code in stock_codes:
        ...
        if len(stock_data) == 1:
            if stock_data['Average_Momentum'].values[0] == 0.8:
...
if len(TotalMoneyList) > 0:
    ...
    #차트 저장
    try:
        chart_filename = os.path.join(source_dir, 'charts', f"MA_Strategy_v7_results_{timestamp}.png")
        plt.savefig(chart_filename, dpi=300, bbox_inches='tight')
...
for result in ResultList:
    ...
    try:
        ...
        save_results(results_data, timestamp, source_dir, "MA_Strategy_v7")
