...
def setup_logging():
    ...
    log_filename = os.path.join(logs_dir, f"MA_Strategy_Test_v2_{timestamp}.log")
...
#차트 저장 함수
def save_charts(df, stock_code, timestamp, source_dir, strategy_name="MA_Strategy_v2"):
    """
    차트를 저장하는 함수
...
#결과 저장 함수
def save_results(results, timestamp, source_dir, strategy_name="MA_Strategy_v2"):
    """
...
logging.info("MA_Strategy_Test_v2 시작")
...
for stock_info in InvestStockList:
    ...
    try:
        ...
        save_charts(df_chart, stock_code, timestamp, source_dir, "MA_Strategy_v2")
    except Exception as e:
...
if len(TotalMoneyList) > 0:
    ...
    #차트 저장
    # try:
    #     chart_filename = os.path.join(source_dir, 'charts', f"MA_Strategy_v2_results_{timestamp}.png")
    #     plt.savefig(chart_filename, dpi=300, bbox_inches='tight')
...
for result in ResultList:
    ...
    try:
        ...
        save_results(results_data, timestamp, source_dir, "MA_Strategy_v2")
