'''
1. 균등할당에 코스피100, 코스닥100에 총 200개 종목에 200개를 균등하게 투자
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
def load_ma_values_from_json(filename="MA_Strategy_Test_v3.json"):
    """
...
def save_ma_values_to_json(ma_values, filename="MA_Strategy_Test_v3.json"):
    """
...
def get_or_create_ma_values(stock_codes, test_area="KR", filename="MA_Strategy_Test_v3.json"):
    """
...
def setup_logging():
    ...
    log_filename = os.path.join(logs_dir, f"MA_Strategy_Test_v3_{timestamp}.log")
...
#차트 저장 함수
def save_charts(df, stock_code, timestamp, source_dir, strategy_name="MA_Strategy_v3"):
    """
    차트를 저장하는 함수
...
#결과 저장 함수
def save_results(results, timestamp, source_dir, strategy_name="MA_Strategy_v3"):
    """
...
logging.info("MA_Strategy_Test_v3 시작")
...
# 시가총액 상위 종목 수 설정
TOP_STOCK_COUNT = 100  # 시가총액 상위 20개 종목 사용
...
for stock_info in InvestStockList:
    ...
    try:
        ...
        #save_charts(df_chart, stock_code, timestamp, source_dir, "MA_Strategy_v3")
    except Exception as e:
...
if len(TotalMoneyList) > 0:
    ...
    #차트 저장
    try:
        chart_filename = os.path.join(source_dir, 'charts', f"MA_Strategy_v3_results_{timestamp}.png")
        plt.savefig(chart_filename, dpi=300, bbox_inches='tight')
...
for result in ResultList:
    ...
    try:
        ...
        save_results(results_data, timestamp, source_dir, "MA_Strategy_v3")
